...
function App() {
  ...
  return (
    // <div className='borderborder-blue-400 py-10 flex flex-row'>
    //   <div className='border border-red-400 w-1/2'>first</div>
    //   <div className='border border-yellow-400 w-1/2'>second</div>
    // </div>
